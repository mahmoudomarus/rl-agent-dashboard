    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <nav className="relative z-20 flex items-center justify-between p-6 lg:px-12">
        ...
        <div className="flex items-center space-x-4">
          <Button 
            variant="ghost" 
            className="text-gray-700 hover:text-lime-600 hover:bg-gray-100"
            onClick={handleSignIn}
          >
            Sign In
          </Button>
          <Button 
            className="bg-gradient-to-r from-lime-600 to-lime-500 text-white font-semibold hover:from-lime-700 hover:to-lime-600 shadow-lg shadow-lime-500/25"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-32">
        <div className="text-center space-y-8">
          <Badge className="inline-flex items-center space-x-2 bg-lime-100 text-lime-700 border-lime-200 px-4 py-2">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 leading-tight">
            Find Your Perfect
            <span className="block bg-gradient-to-r from-lime-600 to-lime-500 bg-clip-text text-transparent">
              Dubai Property
            </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 pt-8">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-lime-600 to-lime-500 text-white font-semibold px-8 py-4 text-lg hover:from-lime-700 hover:to-lime-600 shadow-xl shadow-lime-500/30"
              onClick={handleSignUp}
            >
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-lime-600 text-lime-600 hover:bg-lime-600 hover:text-white px-8 py-4 text-lg"
              onClick={handleSignIn}
            >
              Agent Dashboard
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">
              Powered by
              <span className="text-lime-600"> Artificial Intelligence</span>
            </h2>
            ...
            {features.map((feature, index) => (
              <Card key={index} className="bg-white/80 backdrop-blur-sm border-gray-200 hover:bg-white/90 transition-all duration-300 group shadow-lg">
                <CardContent className="p-8 text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-lime-500 to-lime-400 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              Transforming the
              <span className="block text-lime-600">UAE Real Estate Market</span>
            </h2>
          ...
          <div className="space-y-6">
            <Card className="bg-gradient-to-br from-lime-100 to-lime-50 border-lime-200 backdrop-blur-sm shadow-lg">
              <CardContent className="p-8 text-center">
                <Bot className="h-16 w-16 text-lime-600 mx-auto mb-4" />
            ...
            <Card className="bg-white/80 border-gray-200 backdrop-blur-sm shadow-lg">
              <CardContent className="p-8 text-center">
                <Building2 className="h-16 w-16 text-lime-600 mx-auto mb-4" />
      ...
      {/* CTA Section */}
      <div className="relative z-10 bg-gradient-to-r from-lime-100 to-lime-50 border-t border-lime-200">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-lime-600 to-lime-500 text-white font-semibold px-10 py-4 text-lg hover:from-lime-700 hover:to-lime-600 shadow-xl shadow-lime-500/30"
              onClick={handleSignUp}
            >
              Get Started Today
              <ArrowRight className="ml-2 h-5 w-5" />
